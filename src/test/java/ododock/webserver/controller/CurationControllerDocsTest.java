...
import ododock.webserver.web.exception.WebFluxGlobalExceptionHandler;
import ododock.webserver.web.v1alpha1.CurationController;
...
@WebFluxTest(controllers = CurationController.class)
@Import({RestDocsConfig.class, WebFluxGlobalExceptionHandler.class})
@AutoConfigureRestDocs
@AutoConfigureWebTestClient
public class CurationControllerDocsTest {
    ...
    private V1alpha1BookCurationConverter curationConverter;

    private LibraryBookListOptionsUtil listOptionsUtil;

    public CurationControllerDocsTest() {
    ...
    void listPopularBooks_Docs() throws Exception {
        ...
        listOptionsControllerDto.setPageNo(1);
