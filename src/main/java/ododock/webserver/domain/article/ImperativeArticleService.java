...
public class ImperativeArticleService extends ArticleService {
    ...
    public Publisher<Article> getArticle(final Long articleId) {
...
//                .build();
    ...
    @Transactional(readOnly = true)
    public Publisher<Article> listArticles(ListOptions listOptions) {
        return Flux.fromIterable(articleRepository.findAll());
    }

    @Transactional
    public Publisher<Article> createArticle(ArticleCreate request) {
        ...
        Article newArticle = Article.builder()
                ...
                .build();
        return Mono.just(articleRepository.save(newArticle));
    }

    @Transactional
    public Publisher<Article> updateArticle(Long articleId, ArticleUpdate request) {
        Article article = articleRepository.findById(articleId)
    ...
    @Transactional
    public Publisher<Article> deleteArticle(Long articleId) {
        Article article = articleRepository.findById(articleId)
