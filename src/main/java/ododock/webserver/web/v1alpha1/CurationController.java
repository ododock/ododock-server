...
public class CurationController {
    ...
    public CurationController(LibraryCurationService curationService) {
    ...
    public Flux<V1alpha1Book> listPopularBooks(V1alpha1BookListOptions listOptions) {
        return this.curationService.listPopularContents(this.curationConverter.toDomainDto(listOptions))
                .transform(i -> i
